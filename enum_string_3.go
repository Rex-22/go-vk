...
const _ImageUsageFlagBits_name = "IMAGE_USAGE_TRANSFER_SRC_BITIMAGE_USAGE_TRANSFER_DST_BITIMAGE_USAGE_SAMPLED_BITIMAGE_USAGE_STORAGE_BITIMAGE_USAGE_COLOR_ATTACHMENT_BITIMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BITIMAGE_USAGE_TRANSIENT_ATTACHMENT_BITIMAGE_USAGE_INPUT_ATTACHMENT_BITIMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHRIMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXTIMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHRIMAGE_USAGE_HOST_TRANSFER_BIT_EXTIMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHRIMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXTIMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEIIMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM"
...
var _ImageUsageFlagBits_map = map[ImageUsageFlagBits]string{
	...
	1000440000: _ImageUsageFlagBits_name[521:560],
}
...
func (i InstanceCreateFlagBits) String() string {
	idx := int(i) - 1000394000
	if i < 1000394000 || idx >= len(_InstanceCreateFlagBits_index)-1 {
...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[MEMORY_MAP_PLACED_BIT_EXT-1000272000]
}
...
func (i MemoryMapFlagBits) String() string {
	...
	if i < 1000272000 || idx >= len(_MemoryMapFlagBits_index)-1 {
