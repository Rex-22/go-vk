...
func (i PipelineDepthStencilStateCreateFlagBits) String() string {
	idx := int(i) - 1000463000
	if i < 1000463000 || idx >= len(_PipelineDepthStencilStateCreateFlagBits_index)-1 {
...
func (i PipelineLayoutCreateFlagBits) String() string {
	idx := int(i) - 1000320000
	if i < 1000320000 || idx >= len(_PipelineLayoutCreateFlagBits_index)-1 {
...
const _PipelineStageFlagBits2_name = "PIPELINE_STAGE_2_NONEPIPELINE_STAGE_2_TOP_OF_PIPE_BITPIPELINE_STAGE_2_DRAW_INDIRECT_BITPIPELINE_STAGE_2_VERTEX_INPUT_BITPIPELINE_STAGE_2_VERTEX_SHADER_BITPIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BITPIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BITPIPELINE_STAGE_2_GEOMETRY_SHADER_BITPIPELINE_STAGE_2_FRAGMENT_SHADER_BITPIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BITPIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BITPIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BITPIPELINE_STAGE_2_COMPUTE_SHADER_BITPIPELINE_STAGE_2_ALL_TRANSFER_BITPIPELINE_STAGE_2_BOTTOM_OF_PIPE_BITPIPELINE_STAGE_2_HOST_BITPIPELINE_STAGE_2_ALL_GRAPHICS_BITPIPELINE_STAGE_2_ALL_COMMANDS_BITPIPELINE_STAGE_2_VIDEO_DECODE_BIT_KHRPIPELINE_STAGE_2_VIDEO_ENCODE_BIT_KHRPIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXTPIPELINE_STAGE_2_SUBPASS_SHADER_BIT_HUAWEIPIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEIPIPELINE_STAGE_2_ACCELERATION_STRUCTURE_COPY_BIT_KHRPIPELINE_STAGE_2_MICROMAP_BUILD_BIT_EXTPIPELINE_STAGE_2_CLUSTER_CULLING_SHADER_BIT_HUAWEIPIPELINE_STAGE_2_OPTICAL_FLOW_BIT_NVPIPELINE_STAGE_2_COPY_BITPIPELINE_STAGE_2_RESOLVE_BITPIPELINE_STAGE_2_BLIT_BITPIPELINE_STAGE_2_CLEAR_BITPIPELINE_STAGE_2_INDEX_INPUT_BITPIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BITPIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT"
...
var _PipelineStageFlagBits2_map = map[PipelineStageFlagBits2]string{
	...
	1000314000:   _PipelineStageFlagBits2_name[718:761],
	1000369000:   _PipelineStageFlagBits2_name[761:803],
	1000370000:   _PipelineStageFlagBits2_name[803:846],
	1000386000:   _PipelineStageFlagBits2_name[846:898],
	1000396000:   _PipelineStageFlagBits2_name[898:937],
	1000404000:   _PipelineStageFlagBits2_name[937:987],
	1000464000:   _PipelineStageFlagBits2_name[987:1023],
	4294967296:   _PipelineStageFlagBits2_name[1023:1048],
	8589934592:   _PipelineStageFlagBits2_name[1048:1076],
	17179869184:  _PipelineStageFlagBits2_name[1076:1101],
	34359738368:  _PipelineStageFlagBits2_name[1101:1127],
	68719476736:  _PipelineStageFlagBits2_name[1127:1159],
	137438953472: _PipelineStageFlagBits2_name[1159:1202],
	274877906944: _PipelineStageFlagBits2_name[1202:1248],
}
...
func (i RenderPassCreateFlagBits) String() string {
	idx := int(i) - 1000282000
	if i < 1000282000 || idx >= len(_RenderPassCreateFlagBits_index)-1 {
...
func _() {
	...
	_ = x[RENDERING_CONTENTS_INLINE_BIT_KHR-1000562000]
	_ = x[RENDERING_CONTENTS_INLINE_BIT_EXT-1000562000]
